      ...
      <div className="py-24 sm:py-32 lg:pb-40">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-blue-200 via-blue-400 to-blue-500">
              Simplify Your Workflow with FlowDesk
            </h1>
            <p className="mt-6 text-lg leading-8 text-slate-300">
              Transform chaos into clarity. FlowDesk empowers your team to
              manage tasks, collaborate in real-time, and achieve goals faster
              than ever.
            </p>
