        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left z-10">
            <motion.h1
              ...
              className="text-5xl font-extrabold tracking-tight text-white sm:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-blue-100 via-blue-300 to-indigo-300 pb-2 leading-tight"
            >
              Manage your workflow without chaos.
            </motion.h1>
            <motion.p
              variants={itemVariants}
              className="mt-6 text-lg leading-8 text-slate-300 max-w-2xl mx-auto lg:mx-0 font-light"
            >
          ...
          <motion.div
            variants={itemVariants}
            className="relative mt-16 lg:mt-0 z-10"
          >
            {/* Mockup Container */}
