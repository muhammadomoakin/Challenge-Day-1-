...
const FeatureCard = ({ icon: Icon, title, description }) => {
  return (
    <motion.div
      ...
      className="group relative flex flex-col items-start p-6 bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl hover:border-blue-500/30 transition-colors duration-300 hover:shadow-2xl hover:shadow-blue-500/10"
    >
