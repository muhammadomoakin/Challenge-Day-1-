...
const ValueCard = ({ icon: Icon, title, description }) => {
  return (
    <div className="group p-8 bg-slate-800/40 backdrop-blur-md border border-slate-700/50 rounded-2xl hover:border-blue-500/40 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2">
